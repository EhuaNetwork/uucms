...
<head>
    ...
    <meta name="renderer" content="webkit">
     <link rel="stylesheet" href="https://ecms-devs.oss-cn-beijing.aliyuncs.com/ecms/plug/bootstrap/bootstrap.min.css">
...
<body>
<div class="container-fluid" style="background: rgba(0,0,0,.8);height: 100%">
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-4"
            ...
            <div id="cms-box">
                <form class="form-horizontal" action="./index.php?c=start" method="post">
                    <p style="font-size: 28px;font-weight: bolder;text-align: center;color: #fff;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <a href="https://github.com/EhuaNetwork/uucms"
                               style="display: block;width: 80%;padding-top:15px;text-align: center">Copyright© All
                                rights reserved Powered by UUCMS </a>
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript" src="https://ecms-devs.oss-cn-beijing.aliyuncs.com/ecms/plug/jquery/jquery.js"></script>
<script type="text/javascript" src="https://ecms-devs.oss-cn-beijing.aliyuncs.com/ecms/plug/jquery/jquery.ripples.js"></script>
